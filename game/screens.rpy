...
screen navigation():
        ...
        if main_menu:
            hbox:
                ...
                imagebutton auto "start_%s.png" action Start()

                imagebutton auto "load_%s.png" action ShowMenu("load")

                imagebutton auto "settings_%s.png" action ShowMenu("preferences")

                imagebutton auto "extra_%s.png" action ShowMenu("gallery")
